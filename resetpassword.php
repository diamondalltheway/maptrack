...
$sql = "select * from userdetails where user_id = '".$user."' and tokencode = '".$code."'";

$resultUserId = mysql_query($sql,$conn) or die("Error in Selecting11 " . mysql_error($conn));
if(mysql_num_rows($resultUserId) > 0)
{
...
$userid = $_POST['userid'];
$sqltoupdate = "update userdetails set password = '".$password."',tokencode = '0' where user_id = '".$userid."'";
...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <form class="resetpassowrd" action="" method="post">
				...
				<input type = "hidden" name ="userid" id="userid" value = <?php echo $user; ?>></input>
